	...
	<form id="manage_user">
		<div class="col-md-12">
			...
			<div class="form-group mb-2">
				...
				<input type="text" class="form-control" readonly id="username" name="username" required value="<?php echo isset($meta['username']) ? $meta['username'] : '' ?>">
			</div>
			<div class="form-group mb-2">
				<label for="password" class="control-label">New Password</label>
				<input type="password" class="form-control" id="password" name="password" required value="<?php echo isset($meta['password']) ? '' : '' ?>">
			</div>
		</div>
	</form>
</div>
